...
class Decks : DeckManager() {
    ...
    override fun id(col: Collection, name: String) = id(col, name, DEFAULT_DECK)
    ...
    /** {@inheritDoc}  */
    override fun rem(col: Collection, did: Long, cardsToo: Boolean, childrenToo: Boolean) {
    ...
    */
    ...
    override fun isDyn(col: Collection, did: Long) =
        get(col, did).isDyn
