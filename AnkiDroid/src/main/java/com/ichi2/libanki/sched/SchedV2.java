...
public class SchedV2 extends AbstractSched {
    ...
    public List<DeckDueTreeNode> deckDueList(DeckTask deckTask) {
        _checkDay();
        ...
        for (JSONObject deck : decks) {
            if (deckTask != null && deckTask.isCancelled()) {
                return null;
            }
    ...
    public List<DeckDueTreeNode> deckDueTree(DeckTask deckTask) {
        List<DeckDueTreeNode> deckDueTree = deckDueList(deckTask);
        if (deckDueTree == null) {
            return null;
        }
