...
abstract class Onboarding<Feature, ActivityType>(
    ...
    class AbstractFlashcardViewer(private val mActivityContext: com.ichi2.anki.AbstractFlashcardViewer) :
        Onboarding<AbstractFlashcardViewer.AbstractFlashcardViewerOnboardingEnum, com.ichi2.anki.AbstractFlashcardViewer>(mActivityContext, mutableListOf()) {
    ...
    class CardBrowser(private val mActivityContext: com.ichi2.anki.CardBrowser) :
        ...
        private fun showTutorialForCardClickIfNew() {
            ...
            cardBrowserTutorial.visibility = View.VISIBLE
            // Set visibility to gone state after 4 seconds
            executeFunctionWithDelay({ cardBrowserTutorial.visibility = View.GONE }, 4000)
