...
typealias SyncCallback = ((/*deckPicker: DeckPicker*/) -> Unit)
fun SyncCallback?.invoke(/*deckPicker: DeckPicker*/) = this?.invoke(/*deckPicker*/)
suspend fun SyncCallback?.invokeOnMain(/*/*deckPicker*/: /*deckPicker*/*/) {
    withContext(Dispatchers.Main) {
        this@invokeOnMain.invoke(/*deckPicker*/)
    }
}
