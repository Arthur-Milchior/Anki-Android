 ...
 */
suspend fun checkCardSelection(
    col: Collection,
    checkedCards: Set<CardBrowser.CardCache>
...
fun saveModel(
    ...
    //    - undo (except for cards) could just be Models.update(model) / Models.flush(col) / Collection.reset() (that was prior "undo")
