...
public class CheckMediaTest extends RobolectricTest {
    ...
    public void checkMediaWorksAfterMissingMetaTable() throws ExecutionException, InterruptedException {
        ...
        CollectionTask<Void, Void, PairWithBoolean<List<List<String>>>, PairWithBoolean<List<List<String>>>> task = TaskManager.getManager().launchCollectionTask(new CollectionTask.CheckMedia());
